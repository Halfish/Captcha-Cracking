...
'''
Usage 1: to load picutures from ./testpic/ and dump as *.dat for the training proceedings
Usage 2: util tool for type4_predict.lua to preprocess pictures
    for example:
    > 1. python cutAndDump.py nx      # this will dump ningxia data
    > 2. python cutAndDump.py nx -f single -p ../testpic/type4/ningxia/1.jpg
'''
...
def chongqing():
    num = 99
    label_path = '../testpic/type4/chongqing/label.txt'
    pic_dir = '../testpic/type4/chongqing/'
...
def gansu():
    num = 99
    label_path = '../testpic/type4/gansu/label.txt'
    pic_dir = '../testpic/type4/gansu/'
    save_dir = '../trainpic/type4/'
    with open(label_path, 'r') as f:
        labels = f.readlines()
        for i in range(num):
...
def ningxia():
    num = 99
    label_path = '../testpic/type4/ningxia/label.txt'
    pic_dir = '../testpic/type4/ningxia/'
    save_dir = '../trainpic/type4/'
    with open(label_path, 'r') as f:
        labels = f.readlines()
        for i in range(num):
...
def tianjin():
    num = 99
    label_path = '../testpic/type4/tianjin/label.txt'
    pic_dir = '../testpic/type4/tianjin/'
    save_dir = '../trainpic/type4/'
    with open(label_path, 'r') as f:
        labels = f.readlines()
        for i in range(num):
